...
import { useShowcaseItemGallery } from '../hooks/useShowcaseItemGallery';
...
export default function ShowcaseItemGalleryModal({
  itemId,
  title,
  isOpen,
  onClose,
  ...
  const { createShowcaseItemGallery, isCreating } =
    useShowcaseItemGallery(itemId);
  ...
  const handleUpload = async () => {
    ...
    const success = await createShowcaseItemGallery(formData);
    if (success) {
      setFiles([]);
      onClose();
    }
