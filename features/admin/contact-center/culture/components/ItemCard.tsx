...
import CultureItemGalleryModal from './GalleryModal';
import CultureItemGalleryViewModal from './GalleryViewModal';
...
export function CultureItemCard({ item, onEdit, onDelete }: Props) {
