...
import ShowcaseItemGalleryModal from './GalleryModal';
import ShowcaseItemGalleryViewModal from './GalleryViewModal';
...
export function ShowcaseItemCard({ item, onEdit, onDelete }: Props) {
