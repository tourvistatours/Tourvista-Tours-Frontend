...
import { useCulture } from '@/features/culture/hooks/useCulture';
import { Sparkles, Palmtree } from 'lucide-react';
import { motion } from 'framer-motion';
import PlaceSection from '../../../components/sections/PlaceSection';
import Pagination from '../../../components/common/Pagination';

export default function CultureUserList() {
  const { culture, meta, setFilter, isLoading } = useCulture();

  // LOADING ANIMATION
  if (isLoading && culture.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-48 space-y-12">
        <div className="relative">
          ...
          <div className="relative bg-white dark:bg-slate-900 p-6 rounded-[2.5rem] shadow-2xl border border-slate-100 dark:border-slate-800">
            ...
            >
              <Palmtree size={40} fill="currentColor" fillOpacity={0.2} />
            </motion.div>
