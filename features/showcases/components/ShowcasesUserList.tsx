...
import { useShowcases } from '@/features/showcases/hooks/useShowcases';
import { Sparkles, MapPinned } from 'lucide-react';
import { motion } from 'framer-motion';
import PlaceSection from '../../../components/sections/PlaceSection';
import Pagination from '../../../components/common/Pagination';

export default function ShowcasesUserList() {
  const { showcases, meta, setFilter, isLoading } = useShowcases();
      ...
      <div className="flex flex-col items-center justify-center py-48 space-y-12">
        <div className="relative">
          ...
          <div className="relative bg-white dark:bg-slate-900 p-6 rounded-[2.5rem] shadow-2xl border border-slate-100 dark:border-slate-800">
            ...
            >
              <MapPinned size={40} fill="currentColor" fillOpacity={0.2} />
            </motion.div>
