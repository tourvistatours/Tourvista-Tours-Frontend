...
import { AttractionStats } from '../types/attractions.type';

interface Props {
  stats: AttractionStats | null;
  isLoading: boolean;
  onClick: () => void;
}

export default function AttractionHeader({ stats, isLoading, onClick }: Props) {
  ...
  return (
    <header className="pb-2 space-y-6">
      ...
      <div className="flex justify-center md:justify-start">
        <AdminBadge label="Attractions" variant="blue" />
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center md:items-end justify-between gap-8">
        <div className="flex-1 w-full">
          <PageHeader
            title="Attractions"
            highlight="View"
            subtitle="Manage attraction categories and control how they appear to
